...
export default function Home() {
    return (
        <>
            ...
            <p className="one-desc">{"DEVSHOP allows anyone to buy, use, or sell code. Wether it be full programs {called <<packages>>} or code snippets {called <<snippets>>}, DEVSHOP has it all."}</p>
